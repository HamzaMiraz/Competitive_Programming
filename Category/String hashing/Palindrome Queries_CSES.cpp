...
struct ST{
    ...
    void build(int nod,int sl,int sr){
        ...
        tree[nod].p1 = tree[left_child].p1 + tree[right_child].p1;
        tree[nod].p2 = tree[left_child].p2 + tree[right_child].p2;
        tree[nod].s1 = tree[left_child].s1 + tree[right_child].s1;
        tree[nod].s2 = tree[left_child].s2 + tree[right_child].s2;
    ...
    nn query(int nod,int sl,int sr,int ql,int qr){
        ...
        auto rf=query(right_child,mid+1,sr,ql,qr);
